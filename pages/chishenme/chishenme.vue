<template>
	<view>
		...
		<view class="randomPosition" style="position: relative;">
			<view class="animation-reverse animation-scale-up" v-for="(item,index) in foodList" :key="index" style="position: absolute;" :style="[{top:item.top,left:item.left}]">
